...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _deleteMovie(String movieId) async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Movie deleted successfully')));
      setState(() {}); // Refresh the UI
    } catch (e) {
      print("Error deleting movie: $e");
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Failed to delete movie')));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Movie Watcher')),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () =>
                              _deleteMovie(movie.id), // Call delete function
                          child: Text(
                            'Delete Movie',
